...
## 2 ข้อที่ playbook ไม่ทำให้

playbook **ตรวจ** ทั้งสองข้อเป็น task แรก ๆ **ก่อนแตะอะไรบนเครื่อง** และหยุดถ้ายังไม่ได้ทำ
แต่ **ไม่ทำให้** โดยเจตนา
...
ทำ 2 ข้อที่ playbook ไม่ทำให้ก่อน (หัวข้อข้างบน) แล้ว:
