...
> ```
>
> `KERNEL_UEK` ใน `versions.env` ต้องตรงกับ **ตัวที่จะบูตรอบหน้า** เพราะ playbook
> reboot แล้ว assert ซ้ำหลังบูต · เจอจริง 11 ก.ย. 2026: 6 เครื่องรัน 105/203 ปนกัน
> แต่ทุกเครื่องมี 206 รอบูตอยู่แล้ว
