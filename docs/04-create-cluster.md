...
บรรทัด join จาก 4.1 ใช้ซ้ำกับ master03 ได้ ถ้ายังไม่เกิน 2 ชั่วโมง **และไม่ได้รัน 4.1 ซ้ำระหว่างนั้น**
(รันซ้ำ = บรรทัดเก่าใช้ไม่ได้ทันที ไม่ต้องรอหมดอายุ) · ไม่แน่ใจก็รัน 4.1 ใหม่ ซ้ำได้ไม่มีผลข้างเคียง
— อย่าหยิบจาก `kubeadm-init.log` (จะเจอ `cipher: message authentication failed` ดู
[บทที่ 13 ข้อ 12.5](13-troubleshooting.md))
